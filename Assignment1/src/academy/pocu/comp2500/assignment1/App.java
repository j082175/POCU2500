...
public class App {
    public App(Registry registry) {
        ...
        registry.registerSubcommentUpvoter("Comment", "recommendTheComment"); //: 하위 댓글을 추천하는 메서드를 등록한다.
        registry.registerSubcommentDownvoter("Comment", "notRecommendTheComment"); //: 하위 댓글을 비추천하는 메서드를 등록한다.
